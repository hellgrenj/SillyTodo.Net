...
namespace api.Modules.TodoListModule.Domain.Models
{
    public class TodoListItem
    {
        ...
        // in a more complex app we would not return the domain model entity but rather map the domain model to a DTO or view model or similiar for the API and then leave out this navigation property
        [JsonIgnore]
